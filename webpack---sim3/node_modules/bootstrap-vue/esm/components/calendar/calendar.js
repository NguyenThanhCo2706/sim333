...
import {
    createDate,
    createDateFormatter,
    constrainDate as _constrainDate,
    datesEqual,
    firstDateOfMonth,
    formatYMD,
    lastDateOfMonth,
...
export var BCalendar = extend({
    ...
    render: function render(h) {
        ...
        var $header = h('output', {
                ...
                h('bdi', {
                    staticClass: 'sr-only'
                }, " (".concat(toString(this.labelSelected), ") ")), h('bdi', this.formatDateString(this.selectedDate))
            ] : this.labelNoDateSelected || "\xA0" // '&nbsp;'
        );
        ...
        var $widget = h('div', {
            ...
            attrs: {
                ...
                'aria-describedby': [ // Should the attr (if present) go last?
                    ...
                    this.bvAttrs['aria-describedby'], valueId, gridHelpId
